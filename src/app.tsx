...
import AnnotationsRoot from "./components/ReactComponents/Annotations/AnnotationsRoot.tsx";
...
import { initAnnotations } from "./utils/Annotations/ApplyAnnotations.ts";
...
async function main() {
  ...
  const Hometinue = async () => {
    ...
    {
      const div = document.createElement("div");
      div.classList.add("spicy-annotations-root");
      const reactRoot = ReactDOM.createRoot(div);

      reactRoot.render(<AnnotationsRoot />);
